...
```
implementation 'com.github.wrdlbrnft:modular-adapter:0.3.0.18'
```
...
```groovy
implementation 'com.github.wrdlbrnft:static-list-item-manager:0.3.0.18'
```
...
```groovy
implementation 'com.github.wrdlbrnft:fire-store-item-manager:0.3.0.18'
```
...
```groovy
implementation 'com.github.wrdlbrnft:sorted-list-item-manager:0.3.0.18'
```
