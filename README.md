...
```
compile 'com.github.wrdlbrnft:modular-adapter:0.2.0.1'
```
...
```groovy
compile 'com.github.wrdlbrnft:static-list-item-manager:0.2.0.1'
```
...
```groovy
compile 'com.github.wrdlbrnft:sorted-list-item-manager:0.2.0.1'
```
